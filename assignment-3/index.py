...
fruits = ["Grapes", "Orange", "Cherry", "Peach"]
for fruit in fruits:
    print("I like", fruit)
...
# List of fruits
fruits = ["Orange", "Banana", "Mango", "Grapes"]
...
frozen_numbers = frozenset([50, 60, 70, 80])
...
ferozenset_student = {
    frozenset(["Jawad", "Python"]): 90,
    frozenset(["Hassan", "HTML"]): 95
}
print(ferozenset_student)  

# Another example of a frozenset with fruits
frozen_fruits = frozenset(["mango", "apple", "cherry"])
print(frozen_fruits)

# Trying to add an item to a frozenset (This will cause an error)
frozen_fruits.add("peach")  # ERROR: 'frozenset' object has no attribute 'add'