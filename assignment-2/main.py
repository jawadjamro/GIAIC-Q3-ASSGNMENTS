...
addition1 = 50
addition2 = 20
print(addition1 + addition2)          # 50 + 20 = 70

# -  Subtraction
subtraction1 = 30
subtraction2 = 10  
print(subtraction1 - subtraction2)    # 30 - 10 = 20

# *  Multiplication
multiplication1 = 6
multiplication2 = 3
print(multiplication1 * multiplication2)  # 6 * 3= 18

# /  Division
division1 = 20
division2 = 5
print(division1 / division2)    # 4
...
exponentiation1 = 4
exponentiation2 = 3
print(exponentiation1 ** exponentiation2) # 4 ** 3 = 64
...
value3 = 5
value3 += 5    # value3 = value3 + 10````````````````````````
print(value3)  # 10

value4 = 20
value4 -= 10    # value4 = value4 - 10
print(value4)   # 10

value5 = 10
value5 *= 2    # value5 = value5 * 20
print(value5)   # 20

value6 = 20
value6 /= 5     # value6 = value6 / 4
print(value6)   # 4
...
fruits = ["Mango", "Grapes", "cherry", "Orange"]
...
student1 = {"name": "Jawad", "age": 25, "city": "Karachi"}
